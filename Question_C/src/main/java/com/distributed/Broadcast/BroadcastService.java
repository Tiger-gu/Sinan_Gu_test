...
public class BroadcastService {
    ...
    // That is why I choose the data type ConcurrentHashmap instead of
    ...
    public void broadcast(WsNotification notification, List<String> slaveAddresses, StorageService cache) throws KeeperException, InterruptedException{
